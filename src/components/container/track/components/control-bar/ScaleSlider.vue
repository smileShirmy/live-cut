...
import { ZoomIn as IconZoomIn } from '@icon-park/vue-next'
import { ZoomOut as IconZoomOut } from '@icon-park/vue-next'
...
<template>
  <div class="scale-slider" :class="{ 'is-dragging': dragging }">
